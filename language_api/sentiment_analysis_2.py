...
def analyze_words(filename):
    ...
    for entity in response.entities:
        print('=' * 20)
        print('   keyword: {0}'.format(entity.name))
        print(' sentiment: {0}'.format(entity.sentiment.magnitude))
        print(' magnitude: {0}'.format(entity.sentiment.score))
